...
<div className='navigate'>
    ...
    <div className="offcanvas offcanvas-end text-bg-dark  small" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      <div className="offcanvas-header">
        <h5 className="offcanvas-title" id="offcanvasDarkNavbarLabel">ReadNow</h5>
      ...
      <div className="offcanvas-body">
        <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li className="nav-item">
            <a className="nav-link" href="/">Top Stories</a>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item dropdown">
           ...
           Account
            ...
            <ul className="dropdown-menu dropdown-menu-dark">
              ...
              <li><a className="dropdown-item" href="/">Add another account</a></li>
              <li>
              <a className="dropdown-item" href="/">Settings</a>
              </li>
              <li><a className="dropdown-item" href="/"> Settings</a></li>
              <li><Button variant='contained' style={{marginLeft:"15px"}}>Logout</Button></li>
            </ul>
          </li>
        </ul>
